...
LABEL org.label-schema.schema-version="1.0" \
      ...
      org.label-schema.url="https://github.com/jorgetite/docker-web-faux" \
      org.label-schema.vendor="jorgetite.com" \
      org.label-schema.version=${BUILD_VERSION} \
      org.label-schema.docker.cmd="docker run -d --name blue-app -p 8080:80 jorgetite/webfaux:1.0.blue"
